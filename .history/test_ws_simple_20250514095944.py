# test_ws_simple.py
# Pytest-based test for websocket-client import and version
import pytest
import websocket

def test_websocket_client_import_and_version():
    """Ensure websocket-client library can be imported and has a version attribute."""
