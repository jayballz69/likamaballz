...
docker-compose -f docker-compose.ai.yml config && echo "docker-compose.ai.yml syntax OK" || echo "docker-compose.ai.yml syntax error"
docker-compose -f docker-compose.home.yml config && echo "docker-compose.home.yml syntax OK" || echo "docker-compose.home.yml syntax error"
